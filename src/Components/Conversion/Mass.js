...
//Currently do not know how to route between two components from a dropdown menu
  ...
  const Mass = () =>{
    ...
    return (
        ...
        <><div align="center"><h1>Mass and Weight Conversion</h1>
        ...
        <br></br>
            ...
            <br></br>
                <form>
                    <input id = "initial mass" type='number' style={{fontSize:'20px'}} ref={(input) => {input && input.focus()}}  value = {reValue} placeholder= '0.0' onChange={e => massConvert(e.target.value)}/>
                    <select id = "massType1" style={{fontSize:'20px'}} onChange={e => setValues1(e.target.value)}>
            ...
            <div>
                ...
                <select id = "massType2" style={{fontSize:'20px'}} onChange={e => {setValues2(e.target.value)}}>
                    <option value ="Grams">Grams</option>
                    <option value="Pounds">Pounds</option>
                    <option value ="Ounces">Ounces</option>
                    <option value ="Milligrams">Milligrams</option>
